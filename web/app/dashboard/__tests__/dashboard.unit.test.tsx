...
jest.mock('web/lib/supabaseClient');
import { mockInsert, mockSelect, mockDelete, mockUpdate, mockUpload, mockGetPublicUrl, mockGetUser, mockSignOut, chain } from 'web/lib/__mocks__/supabaseClient';
